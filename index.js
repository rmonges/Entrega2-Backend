...
const {ProductManager} = require("./productManager");//exporto el archivo y lo guardo dentro de llaves

const filePath = "./products.json";

const products = new ProductManager(filePath);//creo el objeto con la clase exportada
